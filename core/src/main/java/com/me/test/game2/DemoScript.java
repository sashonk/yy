...
public class DemoScript {
	...
	static List<Integer> levelsForDemo = Collections.unmodifiableList(Arrays.asList(1,9,5,22,60,13,51,56,30,72,92,35)) ;
			...
			public void run() {
				...
				game.gameLayer.addAction(Util.trigger(Actions.run(new Runnable() {
					...
					public void run() {
						...
						final float yinMoveDuration = (lev==60 || lev == 13 || lev == 30) ? 0.5f : 0.25f;
						float delay = 0;

...
public class TEA {
	...
	public static void main(String[] args) throws Exception {
		...
		TEA tea = new TEA(new byte[]{12,53,23,53,12,65,87,54,23,111,42,12,54,34,66,43});
		String test = "This is tea test string4124";
		byte[] enc =  tea.encrypt(test.getBytes("utf-8"));
